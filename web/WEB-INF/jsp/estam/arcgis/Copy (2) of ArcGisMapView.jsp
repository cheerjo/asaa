...
<link rel="stylesheet" href="${ctx}/css/style.css">    
 ...
 <link rel="stylesheet" href="${ctx}/js3.7/js/dojo/dijit/themes/claro/claro.css">
 <link rel="stylesheet" href="${ctx}/js3.7/js/esri/css/esri.css">
 <style>
       #map {
        padding: 0;
        margin: 0;
...
<script type="text/javascript" src="${ctx}/js3.7/init.js"></script>   
...
//var BASEMAP_URL = "http://10.32.28.202:6080/arcgis/rest/services/asaa/basemap/MapServer";
     ...
     colorTable =
     	new Array(
	        ...
	        featureLayer.on("click", function (evt) {
	        	...
	        	mapClickEvent(fctyNm, fctyCd, gvmtCd);
	        	event.stop(evt);
	        });		       
...
function situateFrame() {
	...
	$("#left_map").css("width",widthViewport - parseInt($("#graph").css("width")) - parseInt($("#map_left").css("width")) - 50);  // 
	$("#left_map").css("height",heightViewport); // heightMiddle legacy IE's require explicit calculation of height.	
	 
	$("#map").css("width",widthViewport - parseInt($("#graph").css("width")) - parseInt($("#map_left").css("width")) - 50);   
	$("#map").css("height",heightViewport);   
...
function newOpen() {
	window.open("${ctx}/html/mmaLegacy.html");
}
</script>
  
   <div id="left_map"  dojotype="dijit.layout.BorderContainer" design="headline" gutters="false"  class="claro">
       <div id="evntinfo"><a href="#" onClick="javascript:newOpen();">전체보기</a></div>
