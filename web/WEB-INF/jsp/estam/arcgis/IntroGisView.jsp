...
<script type="text/javascript" src="${ctx}/js/map/introgismap.js"></script>
	...
	$("#toggle").click(function(e) {
     ...
     colorTable =
     	new Array(
			...
			_map.centerAndZoom(new esri.geometry.Point(127.5, 36.8), 0);
...
function newOpen() {
   ...
   <div id="left_map"  dojotype="dijit.layout.BorderContainer" design="headline" gutters="false"  class="claro"  style="position:relative;">  
       <div id="map" dojotype="dijit.layout.ContentPane" region="center" style="width:680px;height:770px">   
       </div>
   </div>
