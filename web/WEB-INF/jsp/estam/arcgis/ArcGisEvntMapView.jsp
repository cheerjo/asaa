...
<script type="text/javascript" src="${ctx}/js/map/arcgisevntmap.js"></script>
...
function layer_onClick(event)
{
	...
	//mapClickEvent(_selected.attributes.name,_selected.attributes.fctyCd,_selected.attributes.gvmtCd);
}
   ...
   <div id="left_map"  dojotype="dijit.layout.BorderContainer" design="headline" gutters="false"  class="claro"  style="position:relative;">
       ...
       <div id="map" dojotype="dijit.layout.ContentPane" region="center"  style="width:712px;height:830px"> 
        <div id="info" class="esriSimpleSlider">
           안전 : <font style="color:#0621f0;">파란색 </font>
           <br>
           점검필요 : <font style="color:#ac0e0e;">빨간색 </font>
        </div>
       </div>
   </div>
