...
<%
 /**
  * @Class Name : ConEvntDataList.jsp
  * @Description : ConEvntData List 화면
...
function fn_egov_select(ehqkReqId, ehqkTranGbcd) {
	...
	document.getElementById("listForm").ehqkTranGbcd.value = ehqkTranGbcd;
   	document.getElementById("listForm").action = "<c:url value='/conEvntData/updateConEvntDataView.do'/>";
   	document.getElementById("listForm").submit();
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/conEvntData/addConEvntDataView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/conEvntData/ConEvntDataList.do'/>";
   	document.getElementById("listForm").submit();
}
	...
	<div id="table">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
								...
								<th align="center">EhqkFlsv</th>
								<th align="center">EhqkFlnm</th>
			...
			<tr>
						...
						<td align="center" class="listtd"><c:out value="${result.ehqkFlsv}"/>&nbsp;</td>
						<td align="center" class="listtd"><c:out value="${result.ehqkFlnm}"/>&nbsp;</td>
