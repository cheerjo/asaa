...
<script type="text/javascript">
 ...
 function goLeftSearch(){ 
     ...
     document.leftFctyForm.action = "<c:url value='/scn/RglrIptnReport.do'/>"; 
...
function fcRptRglrIptnCenter() { 
    $.ajax({
        type : "POST" //"POST", "GET"
        , async : false //true, false
        , url : "${ctx}/scn/RptRglrIptnInfo.do" //Request URL
        , dataType : "html" //전송받을 데이터의 타입
                                   //"xml", "html", "script", "json" 등 지정 가능
                                   //미지정시 자동 판단
        //, timeout : 30000 //제한시간 지정
...
<div id="contents_wrap">
	<div id="contents">
		...
		<br>
		<div class="content_title"><h2>정기점검보고서</h2>
			<ul class="sub_nav">
				<li><a href="#">홈</a></li>
				<li><a href="#">지진가속도계측기관리</a></li>
				<li class="last">정기점검보고서</li>    <!-- 맨 끝 li에 last class를 넣어주십시오 -->
			</ul>
		</div>
		...
		<div class="a_data_total">
				...
				<div class="widget_header3" id="FctyLeftScl"  style="height:530px;overflow-y:scroll;">           
					<table class="buil_list_tb" id="chTable">
					  ...
					  <c:forEach var="rptmgrList" items="${rptMgrList}" varStatus="status"> 	
						<tr id="fctycd:${rptmgrList.iptDt}:${rptmgrList.fctyCd}:04:${rptmgrList.gvmtCd}">
			...
			<div  id="fctyCenter"   class="a_data_center">
			</div>
