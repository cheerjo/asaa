...
<%
 /**
  * @Class Name : RptMgrEhqkScnRegister.jsp
  * @Description : RptMgrEhqkScn Register 화면
...
<c:set var="registerFlag" value="${empty rptMgrEhqkScnVO.iptDt ? '등록' : '수정'}"/>
...
<!-- validator:javascript formName="rptMgrEhqkScnVO" staticJavascript="false" xhtml="true" cdata="false"/ -->

<script type="text/javaScript" language="javascript" defer="defer">
<!--
/* 글 목록 화면 function */
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/rptMgrEhqkScn/RptMgrEhqkScnList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/rptMgrEhqkScn/deleteRptMgrEhqkScn.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/rptMgrEhqkScn/addRptMgrEhqkScn.do' : '/rptMgrEhqkScn/updateRptMgrEhqkScn.do'}"/>";
    frm.submit();
...
<form:form commandName="rptMgrEhqkScnVO" name="detailForm" id="detailForm" >
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" >
	   ...
	   <tr>
		...
		<tr>
			<th>EHQK_SCN_SRL_NO</th>
			<td>
				<form:input path="ehqkScnSrlNo" cssClass="txt"/>
				&nbsp;<form:errors path="ehqkScnSrlNo" />
			</td>
		</tr>	
		<tr>
		...
		<tr>
			<th>EHQK_SCN_GBN_CD</th>
			<td>
				<form:input path="ehqkScnGbnCd" cssClass="txt"/>
				&nbsp;<form:errors path="ehqkScnGbnCd" />
			</td>
		</tr>	
		<tr>
			<th>EHQK_SCN_PSTN</th>
		...
		<tr>
			<th>CON_RCC_ID</th>
			<td>
				<form:input path="conRccId" cssClass="txt"/>
				&nbsp;<form:errors path="conRccId" />
			</td>
		</tr>	
		<tr>
			<th>INPT_USR_ID</th>
