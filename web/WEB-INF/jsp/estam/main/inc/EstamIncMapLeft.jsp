					...
					<table>
						...
						<tr>
							...
							<td><span  style="cursor:pointer" onClick="javascript:mapfctyKndView('HR','');">고속철도(${readFctyLeft.fcty08})<br></td>
												...
												<tr>
							<td><img src="${ctx}/img/common/ico_map08.png" title="" /></td>
							<td><span  style="cursor:pointer" onClick="javascript:mapfctyKndView('NF','');">원자력(${readFctyLeft.fcty09})<br></td>
						</tr>
<!--
						<tr>
							<td><img src="${ctx}/img/common/ico_map09.png" title="" /></td>
							<td><span  style="cursor:pointer" onClik="javascript:mapfctyKndView('NF','');">원자력
							(${readFctyLeft.fcty09})</span> </td>
						</tr> 
						-->
						<tr>
