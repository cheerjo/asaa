...
<%
/**
 * @Class Name : zipCodeListPopup.jsp
 * @Description : (구)우편번호 조회
...
<head>
    ...
    <meta name="keywords" content="지진,메타정보관리시스템">
		                ...
		                <fieldset>
		                    <ul>
		                        ...
		                        <li>
		                            ...
		                            <input type="text" name="pLawDong" id="text1" style="width:104px" value="<c:out value='${zipCodeVO.pLawDong}'/>">
		                        </li>
		                        <li>
		                            <label for="text2">도로명</label>
		                            <input type="text" name="pDoroNm" id="text2" style="width:104px" value="<c:out value='${zipCodeVO.pDoroNm}'/>">
		                        </li>
		                    </ul>
		                </fieldset>
		                ...
		                <fieldset>
		                    <ul>
		                        <li>
		                            ...
		                            <input type="text" name="pSigungu" id="text3" value="<c:out value='${zipCodeVO.pSigungu}'/>">
		                        </li>
		                        <li>
		                            <label for="text4">리</label>
		                            <input type="text" name="pLawRi" id="text4" value="<c:out value='${zipCodeVO.pLawRi}'/>">
		                        </li>
		                        <li>
		                            <label for="text5">건물명</label>
		                            <input type="text" name="pBldgNm" id="text5" value="<c:out value='${zipCodeVO.pBldgNm}'/>">
		                        </li>
		                    </ul>
		                </fieldset>
	    ...
	    <c:otherwise>
	        <div class="category_popup_wrapper category_popup_wrapper2">
		        <div class="popup_content_wrapper center">
		            ...
		            <fieldset>
		                <label for="text1">우편번호 검색</label> <input type="text" id="text1" name="dong" value="<c:out value='${zipCodeVO.dong}'/>"> <a href="#panel2" class="css_button" onclick="fn_search()"><span>검색</span></a>
		            </fieldset>
