var deployJavaGlobal = function() {
    ...
    function enableWithoutCertMisMatchWorkaround(requestedJREVersion) {
       ...
       if ('MSIE' != deployJavaGlobal.browserName) return true;
       ...
       if (deployJavaGlobal.compareVersionToPattern(deployJavaGlobal.getPlugin().version,
                                     ["10", "0", "0"], false, true)) {
          return true;
       }
    ...
    /* version of deployJavaGlobal.js */
    version: "20120801",
    ...
    returnPage: 'http://jdl.sun.com/webapps/getjava/BrowserRedirect?host=java.com',
    brand: null,
    locale: null,
    installType: null,
        ...
        if (this.isPluginInstalled() &&
            ...
            if (installSucceeded) {
                ...
                if (this.returnPage != null) {
                    top.window.document.location = this.returnPage;
                }
            }
    ...
    installLatestJRE: function(installCallback) {
        if (this.isPluginInstalled() && this.isAutoInstallEnabled()) {
            ...
            if ((this.EAInstallEnabled == 'true') &&
                ...
                if (this.returnPage != null) {
                    this.myInterval =
                        setInterval("deployJavaGlobal.poll()", 3000);
                }
                ...
                if (browser == 'MSIE') {
                    ...
                    top.window.location.href = this.getJavaURL +
    ...
    runApplet: function(attributes, parameters, minimumVersion) {
        ...
        if (this.returnPage == null) {
            ...
            this.returnPage = this.getJavaURL;
        }
  ...
  // fallback to document.URL if documentURI not available
   ...
   createWebStartLaunchButtonEx: function(jnlp, minimumVersion) {
        ...
        var url = 'javascript:deployJavaGlobal.launchWebStartApplication(\'' + jnlp +
      '\');';
    ...
    createWebStartLaunchButton: function(jnlp, minimumVersion) {
        ...
        var url = 'javascript:' +
                  'if (!deployJavaGlobal.isWebStartInstalled(&quot;' +
                      minimumVersion + '&quot;)) {' +
                      'if (deployJavaGlobal.installLatestJRE()) {' +
                        'if (deployJavaGlobal.launch(&quot;' + jnlp + '&quot;)) {}' +
                      '}' +
                  '} else {' +
                      'if (deployJavaGlobal.launch(&quot;' + jnlp + '&quot;)) {}' +
                  '}';
    ...
    */
    ...
    IEInstall: function() {
      ...
      top.window.document.location.href = this.getJavaURL +
            ((this.returnPage != null) ?
            ('&returnPage=' + this.returnPage) : '') +
            ((this.locale != null) ?
            ('&locale=' + this.locale) : '') +
